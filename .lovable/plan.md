...
- **Stripe (`supabase/functions/create-checkout-prueba/index.ts`)**:
...
- **dLocal (`supabase/functions/dlocal-create-payment/index.ts`)**:
...
- **Payment Methods (`src/components/checkout/PaymentMethodsGroup.tsx`)**:
