...
const ProductInglesIngenieriaCivil = lazy(() => import("./pages/ProductInglesIngenieriaCivil"));
            ...
            <RouteErrorBoundary>
              <CartSyncWrapper>
                ...
                <Suspense fallback={<PageFallback />}>
                  ...
                  <Route path="/products/1-000-palabras-ingles-mas-utilizadas-en-ingenieria-civil-n6mm" element={<ProductInglesIngenieriaCivil />} />
                  <Route path="/products/puppy-planner" element={<ProductPuppyPlanner />} />
                ...
                <Route path="/descarga/patrones-ingles" element={<Navigate to="/mi-descarga" replace />} />
                 ...
                 <Route path="/mi-descarga" element={<MiDescarga />} />
                  ...
                  <Route path="/admin/indexing" element={<AdminGate><AdminIndexing /></AdminGate>} />
                  ...
                  {/* Unificado: todo el seguimiento vive en /mi-pedido */}
                  <Route path="/mi-transaccion" element={<Navigate to="/mi-pedido" replace />} />
