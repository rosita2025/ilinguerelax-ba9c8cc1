...
import { BarChart3, Star, Search, LayoutDashboard, LogOut, Globe, Mail, ShieldCheck, GitCompare, TrendingUp, CreditCard, Wallet, Shield } from "lucide-react";
...
const tabs = [
  ...
  { to: "/admin/checkout-abuse", label: "Anti-abuso", icon: Shield },
