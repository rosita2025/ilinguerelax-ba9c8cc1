...
function TextBadge({
  ...
  return (
    <span
      className="inline-flex items-center h-6 px-2 rounded-md text-[11px] font-bold tracking-wide leading-none shadow-sm"
      style={{ background: bg, color }}
    >
      {prefix === "apple" && (
        <svg viewBox="0 0 24 24" width="12" height="12" fill={color} className="mr-0.5" aria-hidden>
