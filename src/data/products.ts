...
export const products: Product[] = [
  ...
  {
    id: "spanish-5000-book",
    slug: "5-000-spanish-words-physical-book",
    name: "5,000 Words Physical Book",
    flag: "🇪🇸",
    country: "Spanish for English Speakers",
    image: "/images/product-spanish-5000.webp",
    title: "Spanish Relax - 5,000 Words Physical Book",
    subtitle: "Softcover · Spanish for English Speakers",
    description: "Physical book with 5,000 Spanish words and English pronunciation guide.",
    rating: 4.8,
    reviews: 0,
    price: 34.99,
    originalPrice: 54.00,
    discount: 48,
    badge: "📖 Physical Book",
    features: ["Softcover", "5,000 words", "English pronunciation", "For English speakers"],
    isPhysical: true,
  },
  {
