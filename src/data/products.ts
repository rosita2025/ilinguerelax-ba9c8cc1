...
export const products: Product[] = [
  ...
  {
    id: "spanish-8000",
    slug: "8-000-spanish-words-with-english-pronunciation",
    name: "8,000 Words",
    flag: "🇪🇸",
    country: "Spanish for English Speakers",
    image: "/images/product-spanish-8000-book.webp",
    title: "Spanish Relax - 8,000 Words Digital",
    subtitle: "Spanish for English Speakers",
    description: "Complete vocabulary with English pronunciation guide. Pre-order at $20 (regular $54).",
    rating: 4.9,
    reviews: 0,
    price: 20.00,
    originalPrice: 54.00,
    discount: 63,
    badge: "🔥 Pre-Order",
    features: ["8,000 words", "English pronunciation", "Phonetic guide UK/USA"],
    isPhysical: false,
    comingSoon: true,
  },
  {
    id: "spanish-8000-book",
    slug: "8-000-spanish-words-physical-book-preorder",
    name: "8,000 Words Physical Book",
    flag: "🇪🇸",
    country: "Spanish for English Speakers",
    image: "/images/product-spanish-8000-book-2.webp",
    title: "Spanish Relax - 8,000 Words Physical Book",
    subtitle: "Softcover · Spanish for English Speakers",
    description: "Physical book with 8,000 Spanish words and English pronunciation. Pre-order at $25 (regular $59).",
    rating: 4.9,
    reviews: 0,
    price: 25.00,
    originalPrice: 59.00,
    discount: 58,
    badge: "🔥 Pre-Order",
    features: ["Softcover", "350-400 pages", "8,000 words", "English pronunciation"],
    isPhysical: true,
    comingSoon: true,
  },
  {
