...
export const products: Product[] = [
  ...
  },
  {
    ...
    slug: "spanish-relax-8000-words-physical-book-preorder",
    name: "Spanish Relax 8,000 — Physical Book (Pre-Order)",
    flag: "🇪🇸",
    country: "Spanish for English Speakers",
    image: "/images/product-spanish-8000-book.webp",
    title: "Spanish Relax - 8,000 Words Physical Book",
    subtitle: "Pre-Order — Ships June 2026",
    description: "8,000 Spanish words with English pronunciation. Pre-order at $15 (regular $35).",
    rating: 4.9,
    reviews: 0,
    price: 15.00,
    originalPrice: 35.00,
    discount: 57,
    badge: "🔥 Pre-Order",
    features: ["8,000 Spanish words", "English pronunciation", "Worldwide shipping via Amazon"],
    isPhysical: true,
    comingSoon: true,
  },
  {
