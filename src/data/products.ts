...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: "Complete structural grammar manual. 1,500+ patterns from A1 to C1 to build perfect Spanish sentences. Physical book, available now.",
    rating: 4.9,
    reviews: 0,
    price: 45.00,
    originalPrice: 45.00,
