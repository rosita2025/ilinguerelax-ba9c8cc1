...
const es: CheckoutUIStrings = {
  ...
  cardTitlePeru: "Tarjeta crédito/débito",
  cardTitleGlobal: "Tarjeta crédito/débito",
...
const en: CheckoutUIStrings = {
  ...
  cardTitlePeru: "Credit/debit card",
  cardTitleGlobal: "Credit/debit card",
...
const pt: CheckoutUIStrings = {
  ...
  cardTitlePeru: "Cartão crédito/débito",
  cardTitleGlobal: "Cartão crédito/débito",
...
const fr: CheckoutUIStrings = {
  ...
  cardTitlePeru: "Carte crédit/débit",
  cardTitleGlobal: "Carte crédit/débit",
