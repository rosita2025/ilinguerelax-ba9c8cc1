...
export const detectCurrency = (countryCode) => {
 ...
 */
const AMBIGUOUS_DOLLAR_CURRENCIES = new Set([
 ...
 */
export const formatAmountLocalized = (amount, decimals) => amount.toLocaleString("es-ES", {
...
export const formatPrice = (priceInUSD, currency, overrides, localUsdPrices) => {
    ...
    const convertedPrice = hasOverride ? override : activeUsd * rate;
