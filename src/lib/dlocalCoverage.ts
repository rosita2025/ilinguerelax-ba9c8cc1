...
export const DLOCAL_COVERAGE: DlocalCountry[] = [
  ...
  { code: "BR", name: "Brasil", flag: "🇧🇷", currency: "BRL",
    transfer: ["Pix", "Santander", "Itaú", "Banco do Brasil"],
  ...
  { code: "MX", name: "México", flag: "🇲🇽", currency: "MXN",
    transfer: ["SPEI", "BBVA Bancomer", "Banorte", "Santander"],
    cash: ["OXXO", "7-Eleven"],
  ...
  { code: "PE", name: "Perú", flag: "🇵🇪", currency: "PEN",
    transfer: ["Transferencia bancaria", "BCP", "Interbank", "BBVA"],
  ...
  { code: "PY", name: "Paraguay", flag: "🇵🇾", currency: "PYG",
    transfer: ["Transferencia bancaria"], cash: ["Infonet", "Pago Express", "Aquí Pago"],
