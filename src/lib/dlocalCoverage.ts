...
export const DLOCAL_COVERAGE: DlocalCountry[] = [
  ...
  { code: "BO", name: "Bolivia", flag: "🇧🇴", currency: "BOB",
    transfer: ["Banco Nacional (BNB)", "Banco Mercantil Santa Cruz", "Banco Unión", "Banco BISA"], cash: ["Pago al Paso", "Efectivo (agentes)"],
    wallet: ["QR bancario (Simple)", "Tigo Money", "Yolo Pago", "Tarjeta de crédito/débito"],
    walletLabel: "Billetera digital (QR y tarjeta)", walletKey: "dlocal_wallet" },
  ...
  { code: "EC", name: "Ecuador", flag: "🇪🇨", currency: "USD",
    transfer: ["Banco Pichincha", "Banco Guayaquil", "Produbanco", "Banco del Pacífico"], cash: ["Pago Efectivo", "Almacenes TIA", "Banco Amazonas", "Banco del Barrio"],
    wallet: ["DeUna", "Payphone", "Peigo"], walletLabel: "Billetera digital", walletKey: "dlocal_wallet" },
  { code: "GT", name: "Guatemala", flag: "🇬🇹", currency: "GTQ",
    transfer: ["Banco Industrial", "Banrural", "BAM", "G&T Continental"], cash: ["PAYCASH (agentes)"],
    wallet: ["Tigo Money", "Zigi"], walletLabel: "Billetera digital", walletKey: "dlocal_wallet" },
  { code: "MX", name: "México", flag: "🇲🇽", currency: "MXN",
    transfer: ["SPEI", "BBVA México", "Banorte", "Santander"],
    cash: ["OXXO", "7-Eleven"],
    wallet: ["Mercado Pago", "Spin by OXXO", "Nu", "Tarjeta Mercado Pago"],
    walletLabel: "Billetera digital", walletKey: "dlocal_mercadopago" },
