...
const CHECKOUT_METHODS: CheckoutMethodDef[] = [
  ...
  { key: "dlocal_transfer", label: "Transferencia bancaria", note: "Transferencia bancaria local vía dLocal Go (SPEI MX, PSE CO, Pix BR, CBU AR, PagoEfectivo/transferencia PE…)", icon: "Building2", regions: ["PE", "GLOBAL"], countryCodes: ["AR", "BR", "CO", "EC", "MX", "PE", "UY", "BO", "CL", "CR", "GT", "PA", "PY", "DO", "SV", "HN", "NI"] },
  { key: "dlocal_cash", label: "Pago en efectivo", note: "Pago en efectivo/agentes vía dLocal Go (OXXO MX, Efecty CO, Boleto BR, Rapipago AR, PagoEfectivo PE…)", icon: "Banknote", regions: ["PE", "GLOBAL"], countryCodes: ["AR", "BR", "CO", "EC", "MX", "PE", "UY", "BO", "CL", "CR", "GT", "PA", "PY", "DO", "SV", "HN", "NI"] },
  { key: "dlocal_wallet", label: "Billetera digital", note: "Billeteras digitales locales vía dLocal Go (Yape/Plin PE, Nequi CO, MACH CL, PicPay BR…)", icon: "Smartphone", countryCodes: ["BO", "BR", "CL", "CO", "CR", "EC", "GT", "PA", "PE", "PY", "UY", "DO", "SV", "HN", "NI"] },
