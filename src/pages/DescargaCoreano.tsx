...
const DescargaCoreano = () => {
    ...
    supabase.functions
      .invoke("register-download-email", {
        body: {
          ...
          productSlug: "coreano-100-mapas",
        },
      })
      .catch((err) => console.warn("register-download-email error:", err));

    localStorage.setItem("coreano_email_captured", "yes");
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO
        title="Descarga · +100 Mapas Mentales de Coreano | ILINGUE RELAX"
        description="Área privada de descarga para compradores del producto Coreano Sin Complicaciones."
      />
      <Navbar />
        ...
        {!unlocked ? (
          ...
          >
            <div className="flex flex-col items-center text-center mb-6">
              ...
              <p className="text-muted-foreground mt-2 text-pretty">
                Ingresa el número de pedido y el correo de tu compra para acceder al material.
              </p>
            </div>
          ...
          >
            ...
            <form onSubmit={handleEmailSubmit} className="space-y-4">
              <div>
                <Label htmlFor="coreano-dl-name">Tu nombre (opcional)</Label>
                <Input
                  id="coreano-dl-name"
                  type="text"
                  value={name}
              ...
              <div>
                <Label htmlFor="coreano-dl-email">Correo electrónico</Label>
                <Input
                  id="coreano-dl-email"
                  type="email"
                  value={email}
            ...
            <div className="grid gap-4">
              <div className="rounded-xl border bg-card p-5 flex flex-col md:flex-row md:items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-semibold text-pretty">{FILE_NAME}</p>
              ...
              <div className="rounded-xl border bg-card p-5 flex flex-col md:flex-row md:items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-semibold text-pretty">{BONO1_NAME}</p>
                ...
                <Button asChild variant="secondary" className="w-full md:w-auto whitespace-normal h-auto py-2">
                  <a href={bono1Asset.url} download target="_blank" rel="noopener noreferrer">
                    <Download className="w-4 h-4 mr-2" /> Descargar
                  </a>
                </Button>
              </div>
              ...
              <div className="rounded-xl border bg-card p-5 flex flex-col md:flex-row md:items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-semibold text-pretty">{BONO2_NAME}</p>
                  <p className="text-xs text-muted-foreground">Bono incluido</p>
                </div>
                <Button asChild variant="secondary" className="w-full md:w-auto whitespace-normal h-auto py-2">
                  <a href={bono2Asset.url} download target="_blank" rel="noopener noreferrer">
                    <Download className="w-4 h-4 mr-2" /> Descargar
                  </a>
                </Button>
              </div>
            ...
            <div className="rounded-lg border border-amber-500/40 bg-amber-500/5 p-4 text-sm text-amber-900 dark:text-amber-200">
              <div className="flex items-start gap-2">
                ...
                <p className="text-pretty">
                  Recuerda: no compartas el material con personas desconocidas. Uso estrictamente personal.
                </p>
              </div>
            </div>
          </motion.div>
