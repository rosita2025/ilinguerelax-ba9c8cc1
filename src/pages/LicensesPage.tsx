...
const CONTENT: Record<"es" | "en" | "fr" | "pt", PageContent> = {
  es: {
    ...
    sections: [
      { icon: BadgeCheck, title: "Marcas Registradas", content: `iLingue Relax™, el logotipo iLingue Relax™ y los eslóganes asociados son marcas comerciales de Youtumundial LLC. Cualquier otra marca de terceros pertenece a sus respectivos titulares.` },
      ...
      { icon: Scale, title: "Servicios de Pago y Terceros", content: `Los pagos son procesados por proveedores externos certificados. Cada proveedor aplica sus propios términos, políticas de privacidad y condiciones de uso. Youtumundial LLC no almacena datos completos de tarjetas ni credenciales bancarias.` },
  ...
  en: {
    ...
    sections: [
      { icon: BadgeCheck, title: "Trademarks", content: `iLingue Relax™, the iLingue Relax™ logo and associated taglines are trademarks of Youtumundial LLC. Any other third-party trademarks belong to their respective owners.` },
      ...
      { icon: Scale, title: "Payment Services & Third Parties", content: `Payments are processed by certified external providers. Each provider applies its own terms, privacy policy and conditions of use. Youtumundial LLC does not store full card data or banking credentials.` },
  ...
  fr: {
    ...
    sections: [
      { icon: BadgeCheck, title: "Marques Déposées", content: `iLingue Relax™, le logo iLingue Relax™ et les slogans associés sont des marques de Youtumundial LLC. Toute autre marque tierce appartient à ses propriétaires respectifs.` },
      ...
      { icon: Scale, title: "Services de Paiement et Tiers", content: `Les paiements sont traités par des prestataires externes certifiés. Chaque fournisseur applique ses propres conditions, politique de confidentialité et conditions d'utilisation. Youtumundial LLC ne stocke aucune donnée complète de carte ni identifiant bancaire.` },
  ...
  pt: {
    ...
    sections: [
      { icon: BadgeCheck, title: "Marcas Registradas", content: `iLingue Relax™, o logotipo iLingue Relax™ e os slogans associados são marcas da Youtumundial LLC. Quaisquer outras marcas de terceiros pertencem a seus respectivos titulares.` },
      ...
      { icon: Scale, title: "Serviços de Pagamento e Terceiros", content: `Os pagamentos são processados por provedores externos certificados. Cada provedor aplica seus próprios termos, política de privacidade e condições de uso. A Youtumundial LLC não armazena dados completos de cartões nem credenciais bancárias.` },
