...
const CONTENT: Record<"es" | "en" | "fr" | "pt", PageContent> = {
  es: {
    ...
    sections: [
      { icon: Trademark, title: "Marcas Registradas", content: `iLingue Relax™, el logotipo iLingue Relax™ y los eslóganes asociados son marcas comerciales de Youtumundial LLC. Otras marcas mencionadas (Hotmart®, Shopify®, Stripe®, PayPal®, Mercado Pago®, Visa®, Mastercard®, Amazon®, Google®, Meta®, WhatsApp®, Instagram®, Facebook®, YouTube®, Brevo®, Resend®, entre otras) pertenecen a sus respectivos titulares y se utilizan únicamente con fines descriptivos o de interoperabilidad, sin implicar patrocinio ni afiliación.` },
