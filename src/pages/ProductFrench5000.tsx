...
import productFrench5000Image from "@/assets/product-french-5000.jpg";

const features = [
  "5,000 palabras esenciales en francés",
...
const ProductFrench5000 = () => {
  ...
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.functions.invoke("send-store-notification", {
        body: { email, storeName: "Francés Relax - 5,000 Palabras", productType: "french" },
      });
  ...
  return (
    <main className="min-h-screen bg-background">
        ...
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative">
                <img src={productFrench5000Image} alt="Francés Relax - 5,000 Palabras en Francés" className="w-full h-auto rounded-2xl shadow-hero" />
              </div>
            </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
                5,000 Palabras en Francés con Pronunciación para Hispanohablantes y Fonética Francesa
              </h1>

              <p className="text-lg text-muted-foreground mb-6">
                Aprende francés de forma relajada con pronunciación adaptada al español. Fonética francesa incluida.
              </p>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-foreground mb-4">
              5,000 Palabras en Francés con{" "}<span className="text-gradient">Pronunciación Hispanohablante</span>
            </h2>
            <p className="text-lg text-muted-foreground text-center mb-12">Todo lo que necesitas para comenzar a hablar francés con confianza</p>
      ...
      <ProductReviews productType="french" reviews={[]} showReviewForm />
      <FAQ
        items={[
          ...
          { question: "¿Qué incluye este libro?", answer: "Incluye 5,000 palabras en francés con pronunciación adaptada para hispanohablantes, fonética francesa y traducción al español.", icon: BookOpen },
          { question: "¿Necesito saber francés para usarlo?", answer: "No. Puedes empezar desde cero. Cada palabra incluye su traducción y pronunciación adaptada al español.", icon: Lightbulb },
        ...
        subtitle="Resolvemos tus dudas sobre 5,000 Palabras en Francés"
      />
      <Footer />
      <WhatsAppButton />
...
export default ProductFrench5000;
