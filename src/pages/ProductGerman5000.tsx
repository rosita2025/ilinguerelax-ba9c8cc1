...
import { Star, Check, BookOpen, Mail, Loader2, Lightbulb, Globe, Sparkles } from "lucide-react";
import { motion } from "framer-motion";
import { useToast } from "@/hooks/use-toast";
import { supabase } from "@/integrations/supabase/client";

const productGerman5000Image = "/images/product-german-5000.webp";

const features = [
  "5,000 palabras esenciales en alemán",
  "Pronunciación adaptada para hispanohablantes",
  "Fonética alemana (IPA)",
  ...
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.functions.invoke("send-store-notification", {
        body: {
          email,
          storeName: "Alemán Relax - 5,000 Palabras",
          productType: "german",
        },
      });
    ...
    <main className="min-h-screen bg-background">
        ...
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative">
                <img
                  src={productGerman5000Image}
                  alt="Alemán Relax - 5,000 Palabras en Alemán"
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
                5,000 Palabras en Alemán con Pronunciación para Hispanohablantes y Fonética Alemana
              </h1>

              <p className="text-lg text-muted-foreground mb-6">
                Aprende alemán de forma relajada con pronunciación adaptada al español. Fonética alemana (IPA) incluida.
              </p>
              ...
              <motion.div
                ...
                className="bg-gradient-to-r from-amber-500/10 to-yellow-500/10 rounded-2xl p-6 border border-amber-500/20 mb-6"
              >
                <div className="flex items-center gap-2 mb-2">
                  <Sparkles className="w-5 h-5 text-amber-600" />
                  <span className="text-amber-600 font-semibold text-sm uppercase">
                ...
                <div className="flex flex-wrap items-baseline gap-x-2 gap-y-1 mb-2">
                  ...
                  <motion.span
                    ...
                    className="px-4 py-2 rounded-full bg-gradient-to-r from-amber-500 to-yellow-500 text-white text-sm font-bold shadow-lg"
                  >
                    AHORRA 78%
                  </motion.span>
                </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-foreground mb-4">
              5,000 Palabras en Alemán con{" "}
              <span className="text-gradient">Pronunciación Hispanohablante</span>
            </h2>
            <p className="text-lg text-muted-foreground text-center mb-12">
              Todo lo que necesitas para comenzar a hablar alemán con confianza
            </p>
      ...
      <FAQ
        items={[
          ...
          { question: "¿Qué incluye este libro?", answer: "Incluye 5,000 palabras en alemán con pronunciación adaptada para hispanohablantes, fonética alemana (IPA) y traducción al español.", icon: BookOpen },
          { question: "¿Necesito saber alemán para usarlo?", answer: "No. Puedes empezar desde cero. Cada palabra incluye su traducción y pronunciación adaptada al español.", icon: Lightbulb },
...
export default ProductGerman5000;
