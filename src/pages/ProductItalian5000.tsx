...
const productItalian5000Image = "/images/product-italian-5000.webp";
...
const ProductItalian5000 = () => {
  ...
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.functions.invoke("send-store-notification", {
        body: { email, storeName: "Italiano Relax - 5,000 Palabras", productType: "italian" },
      });
  ...
  return (
    <main className="min-h-screen bg-background">
        ...
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative">
                <img src={productItalian5000Image} alt="Italiano Relax - 5,000 Palabras en Italiano" className="w-full h-auto rounded-2xl shadow-hero" />
              </div>
            </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
                5,000 Palabras en Italiano con Pronunciación para Hispanohablantes y Fonética Italiana
              </h1>

              <p className="text-lg text-muted-foreground mb-6">
                Aprende italiano de forma relajada con pronunciación adaptada al español. Fonética italiana incluida.
              </p>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-foreground mb-4">
              5,000 Palabras en Italiano con{" "}<span className="text-gradient">Pronunciación Hispanohablante</span>
            </h2>
            <p className="text-lg text-muted-foreground text-center mb-12">Todo lo que necesitas para comenzar a hablar italiano con confianza</p>
      ...
      <ProductReviews productType="italian" reviews={[]} showReviewForm />
      <FAQ
        items={[
          ...
          { question: "¿Qué incluye este libro?", answer: "Incluye 5,000 palabras en italiano con pronunciación adaptada para hispanohablantes, fonética italiana y traducción al español.", icon: BookOpen },
          { question: "¿Necesito saber italiano para usarlo?", answer: "No. Puedes empezar desde cero. Cada palabra incluye su traducción y pronunciación adaptada al español.", icon: Lightbulb },
        ...
        subtitle="Resolvemos tus dudas sobre 5,000 Palabras en Italiano"
      />
      <Footer />
      <WhatsAppButton />
...
export default ProductItalian5000;
