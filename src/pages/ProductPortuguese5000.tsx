...
import productPortuguese5000Image from "@/assets/product-portuguese-5000.png";

const features = [
  "5,000 palabras esenciales en portugués",
  "Pronunciación adaptada para hispanohablantes",
  "Fonética en portugués real",
...
const ProductPortuguese5000 = () => {
  ...
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.functions.invoke("send-store-notification", {
        body: {
          email,
          storeName: "Portugués Relax - 5,000 Palabras",
          productType: "portuguese",
        },
      });
      ...
      toast({
        ...
        description: "Te avisaremos cuando el libro esté disponible. ¡Muy pronto!",
      });
    } catch (error) {
      console.error("Error subscribing:", error);
      toast({
        title: "Error",
        description: "Hubo un error al suscribirte. Intenta de nuevo.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
  ...
  return (
    <main className="min-h-screen bg-background">
        ...
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative">
                <img
                  src={productPortuguese5000Image}
                  alt="Portugués Relax - 5,000 Palabras en Portugués"
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
                5,000 Palabras en Portugués con Pronunciación Adaptada para Hispanohablantes y Fonética en Portugués Real
              </h1>

              <p className="text-lg text-muted-foreground mb-6">
                Aprende portugués de forma relajada con pronunciación adaptada al español. Fonética en portugués real incluida. Solo libro digital.
              </p>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground">
                  💳 Pago único • Sin suscripciones • Acceso de por vida • Libro digital PDF
                </p>
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-card rounded-2xl border-2 border-primary/20 p-6 mb-6"
              >
                {isSubscribed ? (
                  <div className="text-center py-4">
                    ...
                    <p className="text-muted-foreground">
                      Te enviaremos un correo cuando el libro esté disponible. ¡Muy pronto!
                    </p>
                  </div>
                ) : (
                  <>
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Deja tu correo y serás el primero en saber cuando esté disponible.
                    </p>
              ...
              <p className="text-center text-sm text-muted-foreground mb-6">
                📧 Te notificaremos por correo cuando esté disponible
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-foreground mb-4">
              5,000 Palabras en Portugués con{" "}
              <span className="text-gradient">Pronunciación Hispanohablante</span>
            </h2>
            <p className="text-lg text-muted-foreground text-center mb-12">
              Todo lo que necesitas para comenzar a hablar portugués con confianza
            </p>
      ...
      <ProductReviews productType="portuguese" reviews={[]} showReviewForm />
      ...
      <FAQ
        items={[
          ...
          { question: "¿Qué incluye este libro?", answer: "Incluye 5,000 palabras en portugués con pronunciación adaptada para hispanohablantes, fonética en portugués real y traducción al español.", icon: BookOpen },
          { question: "¿Necesito saber portugués para usarlo?", answer: "No. Puedes empezar desde cero. Cada palabra incluye su traducción y pronunciación adaptada al español.", icon: Lightbulb },
          { question: "¿En qué formato estará disponible?", answer: "Estará disponible en formato digital (PDF) con descarga inmediata. Es solo libro digital.", icon: Globe },
        ]}
        title="Preguntas Frecuentes"
        subtitle="Resolvemos tus dudas sobre 5,000 Palabras en Portugués"
      />
...
export default ProductPortuguese5000;
