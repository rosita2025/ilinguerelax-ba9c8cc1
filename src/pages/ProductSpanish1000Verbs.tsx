...
const productImage = "/images/product-spanish-1000-verbs.webp";
  ...
  return (
    <main className="min-h-screen bg-background">
      <SEO
        ...
        image={pricing.coverImageUrl ?? "https://ilinguerelax.com/images/product-spanish-1000-verbs.webp"}
        type="product"
              ...
              <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.3 }} className="bg-gradient-to-r from-blue-500/10 to-emerald-500/10 rounded-2xl p-6 border border-blue-500/20 mb-6">
                ...
                <div className="flex flex-wrap items-baseline gap-x-2 gap-y-1 mb-2">
                  ...
                  {tier.discountPercentage > 0 && (
                    <span className="px-3 py-1 md:px-4 md:py-2 rounded-full bg-gradient-to-r from-blue-500 to-emerald-500 text-white text-xs md:text-sm font-bold shadow-lg">SAVE {tier.discountPercentage}%</span>
                  )}
                </div>
