...
const ProductSpanish5000 = () => {
  ...
  return <main className="min-h-screen bg-background">
      ...
      {/* Cross-sell: Grammar Patterns physical book */}
      <section className="py-12 md:py-16 bg-slate-900 text-white">
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/15 text-accent text-xs font-bold uppercase tracking-wider border border-accent/30">
                <Sparkles className="w-4 h-4" />
                Complete your Spanish journey
              </span>
              <h2 className="text-3xl md:text-4xl font-bold mt-4 mb-3">
                Add the <span className="text-accent">Grammar Patterns</span> physical book
              </h2>
              <p className="text-base md:text-lg text-white/70 max-w-2xl mx-auto">
                Vocabulary gives you the bricks. <strong className="text-white">Grammar Patterns</strong> gives you the system to connect them into perfect, native-sounding sentences — A1 to C1.
              </p>
            </div>

            <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 via-white/[0.02] to-accent/5 p-6 sm:p-8 md:p-10 shadow-card">
              <div className="grid md:grid-cols-2 gap-8 md:gap-10 items-center">
                <div className="flex justify-center">
                  <img
                    src={productGrammarPatternsImage}
                    alt="Spanish Grammar Patterns A1–C1 Mastery — Physical Book"
                    className="w-full max-w-[260px] sm:max-w-[300px] md:max-w-none h-auto rounded-2xl shadow-2xl"
                    loading="lazy"
                  />
                </div>
                <div className="space-y-5 text-center md:text-left">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-500/20 border border-red-500/40 text-red-200 text-xs font-bold">
                    🔥 Pre-Order — Limited launch price
                  </div>
                  <h3 className="text-2xl md:text-3xl font-bold">
                    Grammar Patterns A1–C1 Mastery
                  </h3>
                  <p className="text-white/70 leading-relaxed">
                    1,500+ Spanish grammar patterns, Lego-style sentence building, and native shortcuts — the missing piece between knowing words and actually speaking.
                  </p>
                  <ul className="space-y-3 text-left">
                    {[
                      "1,500+ grammar patterns from A1 to C1",
                      "Past, Present & Future — every mood and tense",
                      "Lego-style sentence building system",
                      "Native shortcuts to sound fluent",
                      "Physical book — ships June 2026",
                    ].map((item) => (
                  ...
                  <Button asChild size="xl" variant="hero" className="w-full">
                    <a href="/products/spanish-grammar-patterns-a1-c1-mastery-preorder">
                      <BookOpen className="w-5 h-5" />
                      Pre-Order Grammar Patterns — $15
                      <ArrowRight className="w-5 h-5" />
                    </a>
                  </Button>
                  <div className="flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-2 text-xs text-white/60 pt-1">
                    <span className="flex items-center gap-1"><Truck className="w-3.5 h-3.5" /> Worldwide shipping</span>
      ...
      {/* Sticky Buy Bar */}
      <StickyBuyBar price={stickyPriceLabel} originalPrice={stickyOriginalLabel} currencyCode={stickyCurrency} productName="Book Physical & Digital — FREE Bonuses" onBuyClick={handleStickyBuy} ctaText={dynamicCtaText} isPhysical={isPhysicalBundle} showReviews={true} rating={4.8} reviewCount={500} lang="en" calmMode dismissible />
