...
const ProductSpanish5000 = () => {
  ...
  const handleBuyNow = async () => {
    ...
    // Open the cart drawer so the user can review and proceed to checkout
    setDrawerOpen(true);
  };
            ...
            <div className="rounded-2xl border-2 border-border bg-card shadow-xl overflow-hidden">
              ...
              {(() => {
                const allReviews: Array<{ name: string; location: string; date: string; text: string; stars: number; photo?: string; photoImg?: string; verified?: boolean }> = [
                  ...
                  { name: "James T.", location: "🇬🇧 UK", date: "3 days ago", text: "Bought this for my retirement trip to Spain. The chapters are well organized — from basics to advanced. The bonuses are incredible value for $27.99.", stars: 5, verified: true },
