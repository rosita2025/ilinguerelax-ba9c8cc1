...
El equipo de iLingue Relax`;
  ...
  <p>Como regalo de bienvenida, aquí tienes tu cupón del <strong>10% de descuento</strong> en todos nuestros productos digitales:</p>
  <p style="font-family: monospace; font-size: 22px; padding: 12px 0;"><strong>NEW10</strong></p>
  <p>Úsalo al finalizar tu compra en <a href="https://ilinguerelax.com/products">ilinguerelax.com/products</a>.</p>
